...
public partial class DnsResolver
{
    ...
    {
        private static readonly Meter s_meter = new Meter("System.Net.NameResolution.Resolver");
    ...
    {
        private const string ActivitySourceName = "System.Net.NameResolution.Resolver";
